...
```{r g1, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap='Zasedena delovna mesta'}
g1
```
...
```{r g2, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap='Prosta delovna mesta'}
g2
```
...
```{r g3, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap='Število aktivnega prebivalstva brez izobrazbe'}
g3
```
...
```{r g4, echo=FALSE, message=FALSE, warning=FALSE,fig.align='center', fig.cap='Gibanje števila zaposlenih v pridelovalnih dejavnostih'}
g4
```

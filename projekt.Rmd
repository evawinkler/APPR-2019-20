...
1. PROSTA DELOVNA MESTA V SLOVENIJI GLEDE NA DEJAVNOSTI 
  ...
  - `prosta mesta` - meritev : prosta mesta glede na leto in dejavnost 
  
2. ZASEDENA DELOVNA MESTA V SLOVENIJI GLEDE NA DEJAVNOSTI 

  - `leto` - leto v katerem so bile meritve opravljene
  - `dejavnost` - spremenljivka : dejavnosti
  - `zasedena mesta` - meritev : zasedena mesta glede na leto in dejavnost  
  
3. DELAVNO AKTIVNO PREBIVALSTVA GLEDE NA AKTIVNOST

  - `leto` - leto v katerem so bile meritve opravljene
  - `dejavnost` - spremenljivka : dejavnosti
  - `delovno aktivno prebivalstvo` - meritev : število delovno aktivnega prebivalstva glede na leto in dejavnost
  
4. MOŠKI GLEDE NA AKTIVNOST V VZHODNI SLOVENIJI 

  - `leto` - leto v katerem so bile meritve opravljene
  - `aktivnost` - spremenljivka : moski glede na aktivnost, način zaposljenosti
  - `moški glede na aktivnost` - meritev : moški glede na aktivnost v Vzhodni Sloveniji, v  tisočih 
  
5. MOŠKi GLEDE NA AKTIVNOST V ZAHODNI SLOVENIJI

  - `leto` - leto v katerem so bile meritve opravljene
  - `aktivnost` - spremenljivka : moski glede na aktivnost, način zaposljenosti
  - `moški glede na aktivnost` - meritev : moški glede na aktivnost v Zahodni Sloveniji, v  tisočih 
  
6. ŽENSKE GLEDE NA AKTIVNOST V VZHODNI SLOVENIJI

  - `leto` - leto v katerem so bile meritve opravljene
  - `aktivnost` - spremenljivka : ženske glede na aktivnost, način zaposljenosti
  - `ženske glede na aktivnost` - meritev : ženske glede na aktivnost v Vzhodni Sloveniji, v  tisočih
  
7. ŽENSKE GLEDE NA AKTIVNOST V ZAHODNI SLOVENIJI 

  - `leto` - leto v katerem so bile meritve opravljene
  - `aktivnost` - spremenljivka : ženske glede na aktivnost, način zaposljenosti
  - `ženske glede na aktivnost` - meritev : ženske glede na aktivnost v Zahodni Sloveniji, v  tisočih 
  
8. POVPREČNE LETNE PLAČE PO DEJAVNOSTIH 

  - `leto` - leto v katerem so bile meritve opravljene
  - `dejavnost` - spremenljivka : dejavnosti
  - `povprečna letna plača` - meritev : povprečna neto plača glede na leto in dejavnost (v €)
  
9. POVPREČNE LETNE PLAČE PO REGIJAH 

 - `leto` - leto v katerem so bile meritve opravljene
  - `regije` - spremenljivka : regije v Sloveniji 
  - `povprečna letna plača` - meritev : povprečna neto plača glede na leto in regijo  (v €)

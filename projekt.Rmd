...
```{r z1, echo=FALSE, message=FALSE, warning=FALSE,fig.align='center', fig.cap='Zemljevid povprečnih neto mesečnih plač po regijah v Sloveniji, leta 2018'}
 z1
```
...
```{r graf.napoved1, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap='Napoved rasti plač v osrednjeslovenski regiji do leta 2022'}
graf.napoved1
```
***

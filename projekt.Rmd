...
5. MOŠKO GLEDE NA AKTIVNOST V ZAHODNI SLOVENIJI 
...
8. POVPREČNE LETNE PLAČE PO DEJAVNOSTIH 
  - `leto` - leto v katerem so bile meritve opravljene
  - `dejavnost` - spremenljivka : dejavnosti
  - `povprečna plača` - meritev : povprečna neto plača glede na leto in dejavnost (v €)

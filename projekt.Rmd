...
4. POVPREČNE LETNE PLAČE PO DEJAVNOSTIH 

  - `leto` - leto v katerem so bile meritve opravljene (število)
  - `dejavnost` - spremenljivka : dejavnosti (besedilo)
  - `povprečna letna plača` - meritev : povprečna neto plača glede na leto in dejavnost (v €) (število)
  
5. POVPREČNE LETNE PLAČE PO REGIJAH 

 - `leto` - leto v katerem so bile meritve opravljene (število)
  - `regije` - spremenljivka : regije v Sloveniji (besedilo)
  - `povprečna letna plača` - meritev : povprečna neto plača glede na leto in regijo  (v €) (število)
...
S pomočjo zemljevida Slovenije lahko vidimo porazdelitev povprečnih plač glede na regije. Razberemo,da najvišja povprečna letna plača v Sloveniji je v Osrednjeslovenski regiji. To je seveda pričakovano, saj se tam nahaja glavno mesto Ljubljana, ki je središče države. Zanimivo je za se za Osrednjeslovensko regijo na drugem mestu nahaja Gorenjska. Sklepam, da na to vplivata večja turistična kraja, kot sta Bled in Kranjska Gora. 

Iz podatkov o povprečnih letnih plačah pri registriranih fizičnih osebah po dejavnostih sem ugotovila naslednje. Iz računala sem povprečne plače v zadnjih 10 letih. 
